...
const HistoryCarousel = ({ bgGrey }) => {
  const historyArray = [
    {
      img: '../images/looking-north.jpg', // Loading src as a result of a function call (map) doesn't work with StaticImage,
    ...
    },
    {
      img: '../images/looking-north.jpg',
      description:
        '17.Elvis & his brother Andrew building 2nd storey of tavern',
      index: 16,
    },
    {
      img: '../images/looking-north.jpg',
        ...
        <Fragment>
          <div className="relative h-0 aspect-w-4 aspect-h-3 sm:aspect-h-9 sm:aspect-w-16">
            <div className="absolute inset-0 flex">
              <StaticImage
                src={
                  '../images/1.1st Advert for Elga, Manning River Times March 1982.jpg'
                }
                alt=""
                className="flex-1"
              />
        ...
        <Fragment>
          <div className="relative h-0 aspect-w-4 aspect-h-3 sm:aspect-h-9 sm:aspect-w-16">
            <div className="absolute inset-0 flex">
              <StaticImage
                src={
                  '../images/4. Date of Elga foundation pouring - 1-6-82.jpg'
                }
                alt=""
                className="flex-1"
              />
        ...
        <Fragment>
          <div className="relative h-0 aspect-w-4 aspect-h-3 sm:aspect-h-9 sm:aspect-w-16">
            <div className="absolute inset-0 flex">
              <StaticImage
                src={
                  '../images/12. looking toward original house from approx spot where tavern now stands.jpg'
                }
                alt=""
                className="flex-1"
              />
        ...
        <Fragment>
          <div className="relative h-0 aspect-w-4 aspect-h-3 sm:aspect-h-9 sm:aspect-w-16">
            <div className="absolute inset-0 flex">
              <StaticImage
                src={
                  '../images/14.Looking toward Black Head Rd, tavern bricks top left, dirt road goes through the tavern car park.jpg'
                }
                alt=""
                className="flex-1"
              />
        ...
        <Fragment>
          <div className="relative h-0 aspect-w-4 aspect-h-3 sm:aspect-h-9 sm:aspect-w-16">
            <div className="absolute inset-0 flex">
              <StaticImage
                src={
                  '../images/17.Elvis & his brother Andrew building 2nd storey of tavern.jpg'
                }
                alt=""
                className="flex-1"
              />
        ...
        <Fragment>
          <div className="relative h-0 aspect-w-4 aspect-h-3 sm:aspect-h-9 sm:aspect-w-16">
            <div className="absolute inset-0 flex">
              <StaticImage
                src={
                  '../images/19.Elvis & Lucy & relative in front of motel 1995.jpeg'
                }
                alt=""
                className="flex-1"
              />
        ...
        <Fragment>
          <div className="relative h-0 aspect-w-4 aspect-h-3 sm:aspect-h-9 sm:aspect-w-16">
            <div className="absolute inset-0 flex">
              <StaticImage
                src={
                  '../images/21.Lucy in front of wallpaper mural in restaurant.jpeg'
                }
                alt=""
                className="flex-1"
              />
        ...
        <Fragment>
          <div className="relative h-0 aspect-w-4 aspect-h-3 sm:aspect-h-9 sm:aspect-w-16">
            <div className="absolute inset-0 flex">
              <StaticImage
                src={
                  '../images/22.aussie tavern social golf club_ and Hallidays point social gold club_.jpg'
                }
                alt=""
                className="flex-1"
              />
