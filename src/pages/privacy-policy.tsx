...
function PrivacyPolicyPage(): React.ReactElement {
  return (
    <>
      ...
      <Layout>
        <div className="relative w-full px-4 mx-auto bg-teal max-w-screen-2xl sm:px-6 lg:px-12">
          <div className="px-6 py-24">
            <h1 className="relative inline-block text-xl leading-none text-white accent-black sm:text-2xl heading-accent">
            ...
            <div className="mt-6 text-white">
              <p>
                ...
                www.hallidayspointtavern.com.au (the “Site” or “we”) collects,
                uses, and discloses your Personal Information when you visit.
              </p>
            </div>
            <h2 className="mt-6 text-xl text-white sm:text-2xl">
            ...
            <div className="mt-6 text-white">
              <p>
                ...
                to perform analytics on Site usage to optimise our Site.
                <br /> Source of collection: Collected automatically when you
                access our Site using cookies, log files, web beacons, tags, or
                pixels.
                <br /> Examples of Personal Information collected: name, email
                address, and phone number.
                <br /> Purpose of collection: to communicate with you, provide
                you with information or advertising relating to our services.
                <br /> Source of collection: collected from you.
                <br />
                Customer support information
                <br /> Purpose of collection: to provide customer support.
                <br /> Source of collection: collected from you.
              </p>
            </div>
            <h2 className="mt-6 text-xl text-white sm:text-2xl">
            ...
            <div className="mt-6 text-white">
              <p>
                ...
                <br /> As described above, we use your Personal Information to
                provide you with targeted advertisements or marketing
                communications we believe may be of interest to you. For
                example:
                <br />
                <br /> We use Google Analytics to help us understand how our
                customers use the Site. You can read more about how Google uses
                your Personal Information here:
                https://policies.google.com/privacy?hl=en.You can also opt out
                of Google Analytics here:
                https://tools.google.com/dlpage/gaoptout.
                <br />
                <br /> For more information about how targeted advertising
                works, you can visit the Network Advertising Initiative’s
                (“NAI”) educational page at
                http://www.networkadvertising.org/understanding-online-advertising/how-does-it-work.
                <br />
                <br /> Additionally, you can opt out of some of these services
                by visiting the Digital Advertising Alliance’s opt-out portal
            ...
            <div className="mt-6 text-white">
              <p>
                ...
                you are a resident of the European Economic Area (“EA”), we
                ...
                <br /> a To perform a task carried out in the public interest;
                <br /> For our legitimate interests, which do not override your
            ...
            <div className="mt-6 text-white">
              <p>
                ...
                effect on a you or otherwise significantly affects you.
                <br />
                <br /> We do not engage in fully automated decision-making that
                ...
                include:
                <br /> Temporary denylist of IP addresses associated with
                repeated failed transactions. This denylist persists for a small
                number of hours. <br />
            ...
            <h2 className="mt-6 text-xl text-white sm:text-2xl">Your Rights</h2>
            <h2 className="mt-6 text-xl text-white sm:text-2xl">GDPR</h2>
            <div className="mt-6 text-white">
              <p>
            ...
            <h2 className="mt-6 text-xl text-white sm:text-2xl">Cookies</h2>
            <div className="mt-6 text-white">
              <p>
                ...
                <br />
                <br /> You can control and manage cookies in various ways.
                Please keep in mind that removing or blocking cookies can
                negatively impact your user experience and parts of our website
                ...
                menu. For more information on how to modify your browser
                settings or how to block, manage or filter cookies can be found
                in your browser’s help file or through such sites as
                www.allaboutcookies.org.
                <br />
                <br /> Additionally, please note that blocking cookies may not
                completely prevent how we share information with third parties
                such as our advertising partners. To exercise your rights or opt
                out of certain uses of your information by these parties, please
                follow the instructions in the “Behavioural Advertising” section
                above.
              </p>
            </div>
            <h2 className="mt-6 text-xl text-white sm:text-2xl">
            ...
            <h2 className="mt-6 text-xl text-white sm:text-2xl">Changes</h2>
            <div className="mt-6 text-white">
              <p>
            ...
            <h2 className="mt-6 text-xl text-white sm:text-2xl">Contact</h2>
            <div className="mt-6 text-white">
              <p>
                For more information about our privacy practices, if you have
                questions, or if you would like to make a complaint, please
                contact us by email at hallidayspointtavern@gmail.com or b y
                mail using the details provided below: SAFRAN, GUY, 551
                Blackhead Rd, Black Head NSW 2430, AustraliaLast updated:
                01/03/2021
              </p>
            </div>
          </div>
